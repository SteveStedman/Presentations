...
---- uncomment out the next block to set up the database and insert some values.
...
--	insert into [Departments] (id, department, parent, archived) values (14, 'Snowshoe', 3, 1);
...
--	insert into [Departments] (id, department, parent, archived) values (17, 'Yoga', 4, 1);
--END
...
BEGIN
	...
	insert into [Departments] (id, department, parent) values (18, '1 Person', 5);
	insert into [Departments] (id, department, parent) values (19, '2 Person', 5);
	insert into [Departments] (id, department, parent) values (20, '3 Person', 5);
	insert into [Departments] (id, department, parent) values (21, '4 Person', 5);

	insert into [Departments] (id, department, parent) values (22, 'Backpacking', 19);
	insert into [Departments] (id, department, parent) values (23, 'Family Camping', 19);
	insert into [Departments] (id, department, parent) values (24, 'Mountaineering', 19);

	insert into [Departments] (id, department, parent) values (25, 'Ultra-lightweight', 24);
	insert into [Departments] (id, department, parent) values (26, 'Lightweight', 24);
	insert into [Departments] (id, department, parent) values (27, 'Standard', 24);

	insert into [Departments] (id, department, parent) values (28, 'Gifts', null);
	insert into [Departments] (id, department, parent) values (29, 'Clearance', null);
